...
local nMapId = me.GetWorldPos();
	-- if nMapId == 1638 then
	-- me.Msg("Noi day khong the mo Ky Tran Cac, vui long tat auto hoi sinh trong auto")
	-- return;
	-- end
		-- local nCurTime = tonumber(GetLocalDate("%H%M"));
	-- if (nCurTime >= 2230 and nCurTime < 1100)  then
	-- if nMapId == 1536 or nMapId == 1537 or nMapId == 1538 or nMapId == 1539 or nMapId == 1540 then
	-- me.Msg("Khong The Mo KY TRAN CAC o day")
	-- return;
	-- end
	-- end
	-- if nMapId == 1832 or nMapId == 2163  or nMapId == 2164  or nMapId == 2165  or nMapId == 2166  or nMapId == 2167 or nMapId == 2168 or nMapId == 2169 then
	-- me.Msg("Noi day khong the mo Ky Tran Cac, vui long tat auto hoi sinh trong auto")
	-- return;
	-- end
	-- if me.nFightState ~= 0 then
		-- me.Msg("Ky Tran Cac Chi Co The Mo Tai Thanh Thi hoac Thon Tran");
		-- return;
	-- end	
	...
	if( t - currentTime ) < 1 then --- cho h?n 10s
		me.Msg("Thao tac qua nhanh");
		return;
	end
	me.SetTask(9155,1,t);
	-- end
