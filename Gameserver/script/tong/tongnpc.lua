...
function Tong:DlgCreateTong(bConfirm, szTong, nCamp)
	...
	--创建扣取金钱说明
	if bConfirm ~= 1 then
		Dialog:Say("Để lập Bang cần có 100 Vạn Lượng，Trong 2 tuần thử nghiệm, Ngân Quỹ bang hội phải lớn hơn 1000 Vạn lượng，Nếu không thì Bang Hội tự tan rã，<color=yellow>Chi phí lập bang là 1000 Vạn Lượng và sẽ không hoàn trả<color> Nhà Ngươi có muốn lập Bang？", 
