...
Atlantis.MIN_LEVEL				= 89;					-- 角色等级限制
Atlantis.MIN_MANTLE				= 6;					-- 披风等级限制
Atlantis.MAX_TIME				= 2 * 60 * 60;					-- 每天2小时
...
{
	[1] = {tbItemId = {18, 1, 1875, 1}, szName = "Rương Mảnh Trang Bị Đồng Hành"},
};
...
{
	[1]  = {[1] = {2, 1, 1519, 10}, [2] = {2, 1, 1520, 10}},
	[2]  = {[1] = {2, 1, 1521, 10}, [2] = {2, 1, 1522, 10}},
	[3]  = {[1] = {2, 2, 1481, 10},  [2] = {2, 2, 1482, 10}},
	[4]  = {[1] = {2, 1, 1523, 10}, [2] = {2, 1, 1524, 10}},
	[5]  = {[1] = {2, 1, 1527, 10}, [2] = {2, 1, 1528, 10}},
	[6]  = {[1] = {2, 1, 1528, 10}, [2] = {2, 1, 1525, 10}},
	[7]  = {[1] = {2, 1, 1531, 10}, [2] = {2, 1, 1529, 10}},
	[8]  = {[1] = {2, 1, 1530, 10}, [2] = {2, 1, 1532, 10}},
	[9]  = {[1] = {2, 1, 1535, 10}, [2] = {2, 1, 1534, 10}},
	[10] = {[1] = {2, 1, 1533, 10}, [2] = {2, 1, 1536, 10}},
	[11] = {[1] = {2, 1, 1537, 10}, [2] = {2, 1, 1538, 10}},
	[12] = {[1] = {2, 1, 1538, 10}, [2] = {2, 1, 1528, 10}},
};
--[[
Atlantis.ITEM_EQUIP_ID =
{
...
-- 回程点坐标
Atlantis.MAP_CITY_POS = {8, 1730, 3393};
...
--[[
	...
	--if tonumber(GetLocalDate("%H%M")) < 1600 then -- mac dinh 1500
	--	return 0;
	--end
	return self.IS_OPEN;
end
