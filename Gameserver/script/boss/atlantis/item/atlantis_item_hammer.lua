...
function tbItem:OnUse()
	...
	GeneralProcess:StartProcess("Vứt bỏ...", 10 * Env.GAME_FPS, {self.OnProcess, self, me.nId, it.dwId}, nil, tbBreakEvent);
...
function tbItem:OnProcess(nPlayerId, nItemDwId)
	...
	if nRet ~= 1 then
		Dialog:Say("Xin Lỗi ! Ngươi không có Thần Khí trên người. ");
		return 0;
	end
