...
FINISH_TIME = 60;		--挑战完成后一 phút后关闭副本
...
nCloseTransferNpcDelay = 55 * 60;	--报名npc存在的时间,55 phút
...
tbTransferName = 
{
	[1] = "Nhất:Cải biến một người",
	[2] = "Nhị:Cải biến lịch sử",
	[3] = "Tam:Cải biến chính đích quá khứ",
	[4] = "Tứ:cải biến một đoạn truyền kỳ",
	[5] = "Ngũ:Chung kết giá tất cả",
};
