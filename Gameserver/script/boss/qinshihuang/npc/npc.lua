...
function tbPassNpc1:OnDialog()
	...
	GeneralProcess:StartProcess("Đến tầng 5 Tần Lăng - nam", 20 * Env.GAME_FPS, {self.OnPassSouth, self}, nil, tbBreakEvent);	
end
...
function tbPassNpc2:OnDialog()
	...
	GeneralProcess:StartProcess("Đến tầng 5 Tần Lăng - bắc", 20 * Env.GAME_FPS, {self.OnPassNorth, self}, nil, tbBreakEvent);	
end
