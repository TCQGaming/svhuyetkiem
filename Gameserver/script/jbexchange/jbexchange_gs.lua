...
function JbExchange:OnLogin()
	me.CallClientScript({"JbExchange:SetPrvAvgPrice", KJbExchange.GetPrvAvgPrice()});
end
...
local giaodichdong = 0 
if giaodichdong == 0 then 
	return 
end
	local nCanOpen = 1;
