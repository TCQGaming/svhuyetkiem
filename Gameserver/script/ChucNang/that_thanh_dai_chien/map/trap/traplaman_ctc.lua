...
local tbMapBienKinhCTC = Map:GetClass(2165); -- µØÍ¼Id
...
function tbMapBienKinhCTC:OnLeave(szParam)
		local pPlayer = me;
	    Map:RegisterMapForbidReviveType(2165, 0, 1, "Mỗi người chỉ có 1 mạng mà thôi!")
...
function tbTrapMapPT:OnPlayer()
	me.NewWorld(2164, 1675,3384);
end;
 
local tbTrapMapTD_TuongDuong	= tbMapBienKinhCTC:GetTrapClass("to_daily")
function tbTrapMapTD_TuongDuong:OnPlayer()
	me.NewWorld(2169, 1665,3474);
end;
