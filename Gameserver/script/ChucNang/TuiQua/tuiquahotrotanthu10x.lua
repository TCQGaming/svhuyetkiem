--Phát triển bởi @TCQGaming Dev


local tbItem = Item:GetClass("tuiquahotrotanthu10x");
local tbItemId = {18,1,2105,11,0,0}
function tbItem:OnUse()
	Dialog:Say("Trang bị hỗ trợ tân thủ.\n<color=red>Mỗi nhân vật chỉ được nhận một lần duy nhất nên hãy cẩn thận<color>", {
			{"Lựa chọn môn phái", self.GetEquipFaction, self, 1, 0},
			{"Kết thúc đối thoại"},
	});
	
end
tbItem.nWeaponLevel		= 10;					-- 宋金体验的武器等级
tbItem.nArmor_Level		= 10;					-- 宋金体验的防具等级
tbItem.tbAddedItem		= {						-- 60级紫装
		{	-- Hệ Kim
			{	-- 刀少林
				[0] = {	--男性
					...
					{2, 10, 624-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},	--护腕cuff
				...
				[1] = {	--女性
					...
					{2, 10, 318-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
			...
			{	-- 	棍少林
				[0]	= {
					...
					{2, 10, 624-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
					{2,  5, 206-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
					{2,  4, 206-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
		...
		{	-- 天王
			...
			{	--	锤天王
				...
				----{2,10,332,10},{2,10,652,10},{2,10,372,10},{2,10,392,10} Nam
	------	{2,10,342,10},{ 2,10,362,10},{2,10,382,10},{2,10,502,10} Nữ
		{	-- Đường Môn
			{	-- Bẫy
				[0]	= {
					...
					{2, 10, 328-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
				...
				[1]	= {
					...
					{2, 10, 358-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
					{2,  5, 216-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
					{2,  4, 216-6+tbItem.nArmor_Level, tbItem.nArmor_Level, -1},
