...
function tbNpc:OnDialog()
	...
	elseif (me.nFaction == 0) then
		...
		if (me.nLevel >= tbNpc.nBottomLevel and me.nLevel < tbNpc.nTopLevel) then
			...
			if BaiHuTang:IsOpenGolden() == 1 and me.nLevel >= 150 then
...
function tbNpc:BuyReputeItem()
		...
		if nFaction <= 0 then
			Dialog:Say("Người chơi chữ trắng không mua được trang bị Bạch Hổ Đường");
			return 0;
		end
