...
function tbWorldBossBase:OnDeath(pNpcKiller, nFlag)
	...
	local szThongBaoTheGioi1 = string.format("Tổ đội của <color=green>%s<color> Kết Liễu Boss Võ Lâm Cao Thủ Câu Hồn Ngọc <color><color=yellow> "..him.szName.."", pPlayer.szName);
