...
Partner.PARTNERLIMIT_MIN		 = 4;		-- 一个玩家默认状态下最多只能有3个同伴
Partner.PARTNERLIMIT_MAX		 = 6;		-- 最多能开到6个同伴
Partner.PERSUADELEVELLIMIT		 = 50;		-- 玩家到100级以后才能说服同伴
...
Partner.SKILLMAXLEVEL			 = 10;		-- 同伴的每个技能等级最大为6
Partner.SKILLUPRATEMIN			 = 30;		-- 默认的同伴技能提升最小概率

Partner.POTENTIAL_MIN			 = 16;		-- 初始潜能随机的最小值
Partner.POTENTIAL_MAX			 = 24;		-- 初始潜能随机的最大值

Partner.SKILLCOUNTMIN 			 = 2;		-- Trong tệp cấu hình hiện tại, số lượng kỹ năng tối thiểu cho mỗi đồng hành được đặt thành 2
Partner.SKILLCOUNTMAX 			 = 4;		-- Tệp cấu hình hiện tại đặt số lượng kỹ năng tối đa cho mỗi người bạn đồng hành là 10
