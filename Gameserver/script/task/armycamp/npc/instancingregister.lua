...
function tbRegister:ChoseInstcing(nInstancingTemplateId, nPlayerId)
	...
	-- Dialog:Say("Hoạt Động Không Diễn Ra");
	-- return;
	-- end
	local nCurTime = tonumber(GetLocalDate("%H%M"));
	if (nCurTime >= 1030 and nCurTime < 1131) or (nCurTime >= 1630 and nCurTime < 1731) or (nCurTime >= 2030 and nCurTime < 2131) or (nCurTime >= 2230 and nCurTime < 2331)then
