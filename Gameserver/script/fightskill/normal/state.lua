...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
	local tbChildInfo	= KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel);
	local tbChildInfo2	= KFightSkill.GetSkillInfo(tbChildInfo.tbEvent.nStartSkillId, tbChildInfo.tbEvent.nLevel);
	local szMsg	= string.format("\nCách %s giay thi tri?n: <color=green>Du Long Chan Khí<color>\n<color=blue>Hi?u qu? b?n than:<color>\nT?c ?? di chuy?n: +<color=gold>%s%%<color>\nC??ng hóa t??ng kh?c ng? hành: +<color=gold>%s<color>\nNh??c hóa t??ng kh?c ng? hành: +<color=gold>%s<color>\n<color=blue>Hi?u qu? ??ng ??i:<color>\nT?c ?? di chuy?n: +<color=gold>%s%%<color>\nC??ng hóa t??ng kh?c ng? hành: +<color=gold>%s<color>\nNh??c hóa t??ng kh?c ng? hành: +<color=gold>%s<color>\nDuy trì <color=gold>%s giay<color>",
		FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime),
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
	...
	local tb = {
			...
			"T? l? làm ch?m: +<color=gold>",
			"T? l? b?ng: +<color=gold>",
			"T? l? choáng: +<color=gold>",
			"T? l? hi?u qu? ng? hành: +<color=gold>",
		};
	...
	local szMsg	= string.format("\n<color=blue>Hi?u qu? b?n than:<color>\nPhát huy l?c t?n c?ng c? b?n: +<color=gold>%s%%<color>\nXác su?t tr?ng thái ng? hành: -<color=gold>%s<color>\nT? l? sinh m?ng: +<color=gold>%s%%<color>\nT? l? n?i l?c: +<color=gold>%s%%<color>\n%s\n<color=blue>Hi?u qu? ??ng ??i:<color>\nPhát huy l?c t?n c?ng c? b?n: +<color=gold>%s%%<color>\nXác su?t tr?ng thái ng? hành: -<color=gold>%s<color>\nT? l? sinh l?c: +<color=gold>%s%%<color>\nT? l? n?i l?c: +<color=gold>%s%%<color>\n%s\nS? m?c tiêu ?nh h??ng l?n nh?t: <color=gold>%s<color>\nDuy trì <color=gold>%s giay<color>",
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
	local tbChildInfo	= KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel);
	local szMsg	= string.format("T? l? tri?n khai khi s?p h?n mê: <color=gold>%d%%<color>\nKh?ng ch?u b?t c? sát th??ng nào, duy trì <color=Gold>%s giay<color>\nTh?i gian gi?n cách: <color=Gold>%s giay<color>",
		tbAutoInfo.nPercent,
		FightSkill:Frame2Sec(tbChildInfo.nStateTime),
		FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime));
	return szMsg;
...
function tbSkill:GetExtraDesc(tbInfo)
	...
	local szMsg	= string.format("<color=gray>(?ang trong tr?ng thái n?u dùng l?n n?a s? ?óng k? n?ng)<color>");
	return szMsg;
end
