local tb	= {
	...
	boss_miqipiaozong={ --弥气飘踪
		...
		addphysicsmagic_p={{{1,100},{2,110}}},
		addphysicsdamage_p={{{1,130},{2,130}}},
	...
	boss_ragegold={ --金系怒气攻击
		appenddamage_p= {{{1,75*0.7*1.1},{10,75*1.1},{11,75*FightSkill.tbParam.nSadd1*1.1}}},
		physicsenhance_p={{{1,125*0.7*1.1},{10,125*1.1},{11,125*FightSkill.tbParam.nSadd1*1.1}}},
		physicsdamage_v={
			[1]={{1,400*0.9*0.7*1.1},{10,400*0.9*1.1},{11,400*0.9*FightSkill.tbParam.nSadd1*1.1}},
			[3]={{1,400*1.1*0.7*1.1},{10,400*1.1*1.1},{11,400*1.1*FightSkill.tbParam.nSadd1*1.1}}
			},
