...
local tb	= {
	...
	huishenjingxin={ --Chí mạng
		deadlystrikeenhance_r={{{1,4},{3,12},{10,40}}},
		skill_statetime={{{1,-1},{2,-1}}}
	},		
	jinghongyiji={ --惊鸿一击
		deadlystrikeenhance_r={{{1,10},{3,30},{10,100}}},
		deadlystrikedamageenhance_p={{{1,5},{3,15},{10,50}}},
		skill_statetime={{{1,-1},{2,-1}}}
	},	
	tabumizong={ --踏步迷踪
	...
	pokongzhanying={ --Phá không trảm ảnh thường
		skilldamageptrim={{{1,1},{3,3},{6,6},{10,10}}},
		skillselfdamagetrim={{{1,1},{3,3},{6,6},{10,10}}},
		skill_statetime={{{1,-1},{2,-1}}}
	},
