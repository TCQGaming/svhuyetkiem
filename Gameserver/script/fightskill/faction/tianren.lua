...
local tb	= {
	...
	huanyingzhuihunqiang={ --幻影追魂枪_10
		state_drag_attack={{{1,40},{10,900},{11,900}},{{1,25},{10,25},{11,25}},{{1,32},{2,32}}},
	...
	feihongwuji={ --飞鸿无迹_10
		...
		skill_mintimepercast_v={{{1,45*18},{10,35*18},{11,33*18}}},
		skill_mintimepercastonhorse_v={{{1,45*18},{10,35*18},{11,33*18}}},
	},
	...
	zhanren120={ --战忍120_10
		...
		deadlystrikedamageenhance_p={{{1,25},{10,30},{11,35}}},
		ignoreattackontime={{{1,18*25},{10,18*15},{13,18*14}}, {{1,18*0.5},{10,18*0.5}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},

	tanzhilieyan={ --1x
		appenddamage_p= {{{1,100},{10,100},{20,100},{21,100*FightSkill.tbParam.nSadd}}},
		seriesdamage_r={{{1,50},{20,100},{21,100}}},
		firedamage_v={
	...
	shehunluanxin={ --Nhiếp hồn loạn tâm
		state_palsy_attack={{{1,35},{10,65},{20,75},{23,85}},{{1,18*1.5},{10,18*2},{20,18*2.5},{21,18*2.6}}},
	...
	tianwailiuxing={ --TNLT
		...
		firedamage_v={
			...
			[3]={{1,750*1.5*FightSkill.tbParam.nS1},{10,750*1.5},{20,750*1.5*FightSkill.tbParam.nS20},{21,750*1.5*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}
			},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
	...
	moyanqisha={ --魔焰七杀
		skilldamageptrim={{{1,1*FightSkill.tbParam.nS100Min},{10,1.5*FightSkill.tbParam.nS100Max}}},
		skillselfdamagetrim={{{1,1*FightSkill.tbParam.nS100Min},{10,1.5*FightSkill.tbParam.nS100Max}}},
		state_burn_attacktime={{{1,10},{10,80}}},
		state_hurt_resisttime={{{1,10},{10,120}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	...
	moren120={ --Ma Đao Thôn Thần - 120 ma Nhẫn
		deadlystrikeenhance_r={{{1,6},{10,60}}},
	...
	moren120_child={ --Ma Đao Thôn Thần - 120 ma Nhẫn
		deadlystrikeenhance_r={{{1,6},{10,60}}},
		seriesdamage_r={{{1,250},{10,250}}},
		appenddamage_p={{{1,10*0.7},{10,30},{11,35}}},
		firedamage_v={
