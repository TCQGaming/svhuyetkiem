...
local tb	= {
	...
	zhanggaiadvancedbook_child={ --掌丐高级秘籍子_10
		skilldamageptrim	={{{1,5},{10,60},{11,60}}},
		skillselfdamagetrim	={{{1,5},{10,60},{11,60}}},
		skill_statetime={{{1,1*18},{10,2.5*18},{11,2.7*18},{11,3*18}}},
	},
	...
	deadlystrikeenhance_r={{{1,25},{10,150},{11,165}}},
	...
	dagouzhenfa={ --打狗阵法_10
		appenddamage_p= {{{1,107*0.7},{10,107},{11,107*FightSkill.tbParam.nSadd}}},
		physicsenhance_p={{{1,125*0.7},{10,125},{11,125*FightSkill.tbParam.nSadd}}},
		firedamage_v={
			[1]={{1,425*0.9*0.7},{10,425*0.9},{11,425*0.9*FightSkill.tbParam.nSadd}},
			[3]={{1,425*1.1*0.7},{10,425*1.1},{11,425*1.1*FightSkill.tbParam.nSadd}}
			},
