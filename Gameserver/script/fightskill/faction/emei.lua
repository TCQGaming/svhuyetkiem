...
local tb	= {
	...
	emeizhangfa={ --峨嵋掌法_10
		addcoldmagic_v={{{1,15},{10,500},{11,525}}},
	...
	cihangpudu={ --慈航普渡_10
		...
		skill_mintimepercast_v={{{1,1*18},{10,1*18},{11,1*18}}},
		skill_mintimepercastonhorse_v={{{1,1*18},{10,1*18},{11,1*18}}},
	...
	foxinciyou_nmc={ --Skill 3x: Nga My Chưởng
		lifereplenish_p={{{1,3},{20,20},{21,21}}},
		lifemax_p={{{1,30},{20,100},{21,105}}},
		manamax_p={{{1,10},{20,50},{22,55}}},
		},
	bumiebujue={ --不灭不绝_10
	...
	liushuixinfa={ --流水心法_20
		damage_all_resist={{{1,10},{20,150},{21,155}}},
		fastwalkrun_p={{{1,10},{20,40},{21,41}}},
	...
	foguangzhanqi={ --佛光战气_10
		addphysicsmagic_p={{{1,50},{10,250},{11,255}}},
	...
	foyinzhanyi={ --佛音战意_20
		appenddamage_p= {{{1,100},{10,145},{20,165},{21,165*FightSkill.tbParam.nSadd}}},
		colddamage_v={
		...
		skill_cost_v={{{1,10},{20,50},{21,50}}},
		addskilldamagep={837, {{1,2},{20,30},{21,35}},1},
		addskilldamagep2={1192, {{1,2},{20,30},{21,35}}},
		},
	qingyinfanchang={ --清音梵唱_20
		addphysicsmagic_p={{{1,30},{20,200},{30,300},{31,307}}},
		allseriesstateresisttime={{{1,60},{10,125},{20,175},{21,182},{27,224},{28,224}}},
	},
	qingyinfanchang_team={ --清音梵唱_20
		allseriesstateresisttime={{{1,50},{10,100},{20,150},{21,155},{27,185},{28,185}}},
	},
	boluoxinjing={ --波罗心经_20
		state_slowall_attacktime={{{1,10},{20,80}}},
		state_burn_resisttime={{{1,10},{20,120}}},
	...
	liushuijue={ --流水诀_20
-----------------------------------skill lam them-------------------------------
		addcoldmagic_v={{{1,15},{20,700},{21,725}}},
		deadlystrikeenhance_r={{{1,10},{20,100},{21,105}}},
		castspeed_v={{{1,30},{20,43},{21,46},{22,46}}},
		state_slowall_attackrate={{{1,10},{20,100}}},
		state_burn_resistrate={{{1,10},{20,150}}},
		skill_appendskill2={{{1,101},{20,101}},{{1,1},{20,20}}},
		skill_appendskill4={{{1,108},{20,108}},{{1,1},{20,30}}},
		skill_appendskill5={{{1,482},{20,482}},{{1,1},{20,7}}},
		--------------------------------------------------------------------------------
		},
	puduzhongsheng={ --普渡众生_10
	damage_all_resist={{{1,50},{10,200},{11,215}}},

	},
	puduzhongsheng_team={ --普渡众生_10
	damage_all_resist={{{1,25},{10,100},{11,107}}},
	...
	qianfoqianye={ --千佛千叶_20
		...
		state_slowall_attackrate={{{1,10},{20,100}}},
		state_burn_resistrate={{{1,10},{20,150}}},
		castspeed_v={{{1,10},{10,33},{11,36},{12,36}}},
	...
	jianyingfoguang={ --剑影佛光_10
		appenddamage_p= {{{1,100*0.7},{20,100},{21,100*FightSkill.tbParam.nSadd}}},
		colddamage_v={
		...
		state_slowall_attack={{{1,35},{20,65},{21,66}},{{1,45},{20,45},{21,45}}},
		seriesdamage_r={{{1,250},{20,250},{21,250}}},
		missile_hitcount={{{1,5},{20,5},{21,5}}},
		skill_cost_v={{{1,100},{20,200},{21,200}}},
	},
	jianyingfoguang_child={ --剑影佛光子_10
		appenddamage_p= {{{1,50*0.7},{20,50},{21,50*FightSkill.tbParam.nSadd}}},
		colddamage_v={
	...
	fue120_team={ ----辅峨120_子_10
		defencedeadlystrikedamagetrim={{{1,5},{10,40},{11,42}}},
	},
}
