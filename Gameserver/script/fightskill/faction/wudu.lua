...
local tb	= {
	...
	wududaofa={ --五毒刀法_10
		addphysicsdamage_p={{{1,5},{10,280},{11,295}}},
	...
	shidushu={ --施毒术_20
		...
		deadlystrikeenhance_r={{{1,50},{20,200},{21,215}}},
		deadlystrikedamageenhance_p={{{1,5},{20,35},{21,37}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	wenguzhiqi={ --瘟蛊之气_10
	...
	wangushixin_child={ --万蛊蚀心_20
		damage_all_resist={{{1,-20},{20,-220},{21,-230}}},
		skilldamageptrim={{{1,-1},{20,-15},{22,-16}}},
		skillselfdamagetrim={{{1,-1},{20,-15},{22,-16}}},
	...
	zhuhaqingming={ --朱蛤青冥_10 只是显示用
		...
		appenddamage_p= {{{1,200},{10,250},{11,260}}},
		poisondamage_v={{{1,500},{10,1000},{11,1050}},{{1,9*4},{20,9*4}}},
	...
	zhuhaqingming1={ --朱蛤青冥_10
		state_stun_attack={{{1,35},{10,100},{11,100}},{{1,36},{10,36}}},
		appenddamage_p= {{{1,100},{10,120},{11,123}}},
		poisondamage_v={{{1,100},{10,250},{11,265}},{{1,9*4},{20,9*4}}},
		missile_hitcount={{{1,7},{10,7}}},
	...
	daodu120_child1={ --刀毒120_对敌加攻击_10
		skilldamageptrim={{{1,9},{10,30},{11,32}}},
		skillselfdamagetrim={{{1,9},{10,30},{11,32}}},
	...
	wuduzhangfa={ --五毒掌法_10
		addpoisonmagic_v={{{1,2},{10,250},{11,260}},{{1,10*9},{20,10*9}}},
		addphysicsmagic_p={{{1,20},{10,55},{11,60}}},
		deadlystrikeenhance_r={{{1,30},{10,50},{11,55}}},
	...
	beimoxueguang_child={ --悲魔血光&子_20
		deadlystrikeenhance_r={{{1,-20},{10,-120},{20,-220},{21,-235}}},
	...
	chuanxinduci={ --穿心毒刺_10
		...
		deadlystrikedamageenhance_p={{{1,5},{10,20},{11,22}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	qudushu={ --驱毒术_10
	...
	yinfengshigu={ --阴风蚀骨
		appenddamage_p= {{{1,56*FightSkill.tbParam.nS1},{10,56},{20,56*FightSkill.tbParam.nS20},{21,56*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
	...
	yinfengshigu_child={ --天罡毒手，阴风蚀骨第二式
		appenddamage_p= {{{1,28*FightSkill.tbParam.nS1},{10,28},{20,28*FightSkill.tbParam.nS20},{21,28*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
	...
	huagumianzhang={ --化骨绵掌_10
		appenddamage_p= {{{1,250},{10,315},{11,325}}},
		poisondamage_v={{{1,500},{10,1100},{11,1150}},{{1,9*5},{10,9*5}}},
		missile_hitcount={{{1,3},{10,5},{11,5}}},
		seriesdamage_r={{{1,100},{10,250},{11,250}}},
		skill_mintimepercast_v={{{1,3.5*18},{10,3.5*18}}},
		skill_mintimepercastonhorse_v={{{1,3.5*18},{10,3.5*18}}},
	},
	...
	zhangduadvancedbook_child={ --掌毒高级秘籍子_10
		damage_poison_resist={{{1,-50},{10,-140},{11,-155}}},
		superposemagic={{{1,2},{10,5},{11,5}}},
