...
local tb	= {
	...
	tangmenxianjing={ --唐门陷阱_10
		addphysicsdamage_p={{{1,10},{10,100},{11,110}}},
	...
	luanhuanji_child3={ --乱环击子3
		...
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
		state_knock_attack={{{1,30},{10,50},{20,80}},{{1,1},{10,4},{20,6}},{{1,32},{2,32}}},
	...
	jiguanmishu={ --skill 6x ham tinh
		deadlystrikeenhance_r={{{1,30},{10,75},{11,82}}},
	...
	xianjingadvancedbook={ --高级秘籍_10
		...
		skill_statetime={{{1,3*18},{10,7*18},{12,8*18}}},
		skill_skillexp_v=FightSkill.tbParam.tbHighBookSkillExp,
	},

	xianjing120={ --陷阱120_10
		addenchant={28, {{1,1}, {2, 2}}},
		ignoreskill={{{1,3},{10,13}},0,{{1,3},{2,3}}},
		skilldamageptrim	={{{1,5},{10,15}}},
		skill_cost_v={{{1,500},{10,500}}},
		skill_mintimepercast_v={{{1,30*18},{10,30*18}}},
		skill_statetime={{{1,5*18},{10,10*18},{12,11*18}}},
	},
	...
	zhuixinjian={ --追心箭_20
		appenddamage_p={{{1,150},{20,150},{21,150*FightSkill.tbParam.nSadd}}},
		physicsenhance_p={{{1,5},{10,100},{20,150},{21,150*FightSkill.tbParam.nSadd}}},
	...
	tangmenxiujian={ --唐门袖箭_10
		addphysicsdamage_p={{{1,10},{10,230},{11,240}}},
	...
	cuidushu_team={ --淬毒术_队友
		deadlystrikedamageenhance_p={{{1,10},{10,30},{20,60},{21,63}}},
	},
	tianluodiwang={ --天罗地网_20
		appenddamage_p= {{{1,65},{20,65},{21,65*FightSkill.tbParam.nSadd}}},
		...
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
		poisondamage_v={{{1,120},{10,165},{20,215},{21,215*FightSkill.tbParam.nSadd}},{{1,10*9},{20,10*9}}},
	...
	tianluodiwang_child={ --天罗地网子
		...
		state_weak_attack={{{1,15},{10,45},{20,50},{21,51}},{{1,36},{20,54},{21,54}}},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
		poisondamage_v={{{1,70},{10,85},{20,95},{21,100}},{{1,10*9},{20,10*9}}},
		missile_speed_v={30},
		missile_range={1,0,1},
		},
	duanjinren={ --断筋刃_10
	...
	qijueshaguang_child={ --七绝煞光子
		deadlystrikeenhance_r={{{1,50},{10,220},{11,230}}},
	...
	xiujian120={ --袖箭120_10
		appenddamage_p={{{1,200*0.7},{10,200},{11,200*FightSkill.tbParam.nSadd}}},
		poisondamage_v={{{1,1000*0.7},{10,1000},{11,1000*FightSkill.tbParam.nSadd}},{{1,9*9},{20,9*9}}},
		seriesdamage_r={{{1,250},{10,250}}},
		skill_cost_v={{{1,150},{10,150}}},
		skill_mintimepercast_v={{{1,18*5},{10,18*5}}},
		skill_mintimepercastonhorse_v={{{1,18*5},{10,18*5}}},
	},
