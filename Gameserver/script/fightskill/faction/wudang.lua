...
local tb	= {
	...
	chunyangwuji={ --纯阳无极_10
		staticmagicshieldcur_p ={{{1,170},{10,195},{11,205}},{{1,15*18},{10,15*18},{11,15*18}}},
	...
	zhenwuqijie_team={ --真武七截
		addphysicsmagic_p={{{1,35},{20,100},{21,105}}},
	},
	zhenwuqijie={ --真武七截_20
	...
	tiandiwuji={ --天地无极
		...
		missile_hitcount={{{1,5},{5,5},{10,5},{15,5},{20,5},{21,5}}},
	},
	taijiwuyi={ --太极无意_20
...
-- skill vd
	wudangjiuyanggong={ --武当九阳功_10
		attackenhancebycostmana_p={{{1,1},{10,3},{11,3}}},
		state_stun_attackrate={{{1,55},{10,105},{11,110}}},
	...
	qiwuadvancedbook_child={ --高级秘籍子
		appenddamage_p= {{{1,60*0.7*1.2},{10,60*1.2},{11,60*1.2*1.05}}},
		lightingdamage_v={
			[1]={{1,1300*0.9*0.7*1.2},{10,1300*0.9*1.2},{11,1300*0.9*1.2*1.05}},
			[3]={{1,1450*1.1*0.7*1.2},{10,1450*1.1*1.2},{11,1450*1.1*1.2*1.05}},
			},
	...
	qiwu120_child={ --气武120_子_10
		deadlystrikeenhance_r={{{1,30*0.7},{10,30},{11,30*FightSkill.tbParam.nSadd}}},
	...
	liuxingganyue={ --中级秘籍：流星赶月
		appenddamage_p= {{{1,175*0.7},{10,175},{11,175*FightSkill.tbParam.nSadd}}},
		seriesdamage_r={{{1,100},{10,250},{11,250}}},
		physicsenhance_p={{{1,250*0.7},{10,250},{11,250*FightSkill.tbParam.nSadd}}},
		lightingdamage_v={
			[1]={{1,2000*0.9*0.7},{10,2000*0.9},{11,2000*0.9*FightSkill.tbParam.nSadd}},
			[3]={{1,2000*1.1*0.7},{10,2000*1.1},{11,2000*1.1*FightSkill.tbParam.nSadd}}
		},
		state_fixed_attack={{{1,35},{10,85},{12,90}},{{1,18*2},{20,18*2}}},
		skill_cost_v={{{1,50},{10,100},{11,100}}},
		skill_mintimepercast_v={{{1,5*18},{10,5*18},{11,5*18}}},
		skill_mintimepercastonhorse_v={{{1,5*18},{10,5*18},{11,5*18}}},
	...
	mizhonghuanying={ --迷踪幻影
		addedwith_enemycount={{{1,1185},{10,1185}},{{1,3},{10,10},{17,12}}, {{1,1600},{10,1600}}},
		skill_statetime={{{1,-1},{2,-1}}}
	},
	mizhonghuanying_child={ --迷踪幻影子
		ignoreskill={{{1,4},{10,4}},0,{{1,6},{2,6}}},
		stealmanaenhance_p={{{1,3},{10,3}},{{1,100},{10,100}}},
		skilldamageptrim={{{1,3},{10,3}}},
		skill_statetime={{{1,18*2},{2,18*2}}},
	},
	jianwuadvancedbook={ --剑武高级秘籍_10
		appenddamage_p= {{{1,200},{10,250},{11,275}}},
		physicsenhance_p={{{1,200},{10,275},{11,300}}},
		lightingdamage_v={
			[1]={{1,2500*0.9*0.7},{10,2500*0.9},{14,2500*0.9*1.2}},
			[3]={{1,2500*1.1*0.7},{10,2500*1.1},{14,2500*1.1*1.2}}
			},
		seriesdamage_r={{{1,250},{10,250}}},
	...
	jianwu120_child2={ --剑武120_子子_10
		fastwalkrun_p={{{1,-1},{10,-3},{11,-3}}},
		allseriesstateresisttime={{{1,-5},{10,-25},{13,-30}}},
		superposemagic={{{1,1},{10,10},{12,11}}},
