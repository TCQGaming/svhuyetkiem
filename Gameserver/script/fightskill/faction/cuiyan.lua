...
local tb	= {
	...
	bihaichaosheng={ --碧海潮生_20
		appenddamage_p= {{{1,100},{10,110},{20,120},{21,120*FightSkill.tbParam.nSadd}}},
		colddamage_v={
	...
	shimianmaifu_self={ --十面埋伏自身_10
		...
		skilldamageptrim={{{1,3},{10,25}}},
		skillselfdamagetrim={{{1,3},{10,25}}},
		...
		skill_mintimepercast_v={{{1,45*18},{10,45*18},{11,45*18}}},
		skill_mintimepercastonhorse_v={{{1,45*18},{10,45*18},{11,45*18}}},
	},
	shimianmaifu={ --十面埋伏_队友_10
		autoskill={{{1,71},{2,71}},{{1,1},{10,10}}},
		skill_statetime={{{1,15*18},{10,15*18},{11,15*18}}},
	},
	shimianmaifu_child={ --十面埋伏_队友_子_10
		hide={0,{{1,15*18},{10,15*18}}, 2},
	},

	jiancuiadvancedbook={ --剑翠高级秘籍_飞絮飘花_10
		appenddamage_p= {{{1,30*0.5},{10,30},{11,30*1.05}}},
		colddamage_v={
			[1]={{1,150.5*0.9*0.5},{10,150.5*0.9},{11,150.5*0.9*1.05}},
			[3]={{1,150.5*1.1*0.5},{10,150.5*1.1},{11,150.5*1.1*1.05}}
			},
		seriesdamage_r={{{1,250},{10,250}}},
		state_slowall_attack={{{1,3},{10,30}},{{1,45},{10,45}}},
		state_fixed_attack={{{1,1},{10,15}},{{1,18*2},{10,18*2}}},
	},
	...
	jiancui120_child={ --剑翠120_子_10
		...
		colddamage_v={
			[1]={{1,400*0.9*0.7},{10,400*0.9},{11,400*0.9*FightSkill.tbParam.nSadd}},
			[3]={{1,400*1.1*0.7},{10,400*1.1},{11,400*1.1*FightSkill.tbParam.nSadd}}
			},
		seriesdamage_r={{{1,250},{10,250}}},
	...
	yuxueyin={ --御雪隐_10
		...
		hide={0,{{1,5*18},{10,5*18},{13,5*18}}, 1},
		skill_mintimepercast_v={{{1,7*18},{10,7*18},{11,7*18}}},
		skill_mintimepercastonhorse_v={{{1,7*18},{10,7*18},{11,7*18}}},
	},
	yuxueyin_child={ --御雪隐_会心
		deadlystrikeenhance_r={{{1,2000},{10,4000},{11,4400}}},
		deadlystrikedamageenhance_p={{{1,5},{10,25},{11,27}}},
		attackspeed_v={{{1,20},{10,50},{11,55}}},
		skill_statetime={{{1,5*18},{10,5*18},{12,5*18}}},
	},
	muyeliuxing={ --牧野流星_20
		appenddamage_p= {{{1,50},{20,50},{21,50*FightSkill.tbParam.nSadd}}},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
		physicsenhance_p={{{1,50},{10,86},{20,126},{21,126*FightSkill.tbParam.nSadd}}},
		colddamage_v={
	...
	bingxinqianying={ --冰心倩影_20
		...
		damage_all_resist={{{1,10},{20,100},{22,105}}},
		deadlystrikedamageenhance_p={{{1,1},{20,20},{21,22}}},
		lifemax_p={{{1,15},{20,30},{21,32}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	bingzongwuying={ --冰踪无影
		appenddamage_p= {{{1,45*1.1*FightSkill.tbParam.nS1},{10,45*1.1},{20,45*1.1*FightSkill.tbParam.nS20},{21,45*1.1*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
	...
	bingjiyugu={ --冰肌玉骨_20
		state_slowall_attackrate={{{1,10},{20,100}}},
		state_burn_resistrate={{{1,10},{10,100},{20,150}}},
		attackspeed_v={{{1,10},{10,26},{20,36},{23,39},{24,39}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	qianlibingfeng={ --千里冰封
		skilldamageptrim={{{1,1*FightSkill.tbParam.nS100Min},{10,1*FightSkill.tbParam.nS100Max}}},
	...
	guiqulaixi={ --归去来兮_10
		...
		deadlystrikedamageenhance_p={{{1,13},{10,50},{11,52}}},
		ignoredefenseenhance_v={{{1,50},{10,250},{11,265}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	daocuiadvancedbook={ --刀翠高级秘籍_夜来西风_10
		appenddamage_p= {{{1,10},{10,30},{11,33}}},
		colddamage_v={
			[1]={{1,215*0.9*0.7},{10,215*0.9},{11,215*0.9*1.2}},
			[3]={{1,215*1.1*0.7},{10,215*1.1},{11,215*1.1*1.2}}
			},
		seriesdamage_r={{{1,100},{10,250},{11,250}}},
		missile_hitcount={{{1,2},{10,5},{11,5}}},
	...
	daocui120_child={ --刀翠120_伤害增加_10
		...
		skilldamageptrim={{{1,3},{10,14},{11,15}}},
		skillselfdamagetrim={{{1,3},{10,14},{11,15}}},
