...
local tb	= {
	...
	jingleipotian_child={ --惊雷破天子
		...
		skill_statetime={{{1,18*2},{10,18*3},{11,18*3.2}}},
	},
	...
	qiangtianadvancedbook_child={ --枪天高级秘籍_10
		...
		superposemagic={{{1,10},{10,33},{11,34}}},
	...
	tianwangbensheng_child={ --天王本生子
		...
		skill_statetime={{{1,18*2},{10,18*5},{11,18*5.2}}},
	},
	jinzhongzhao={ --金钟罩_20
	...
	chuitianadvancedbook_child={ --锤天高级秘籍_10
		skilldamageptrim		={{{1,1},{10,15},{11,16}}},
		skillselfdamagetrim		={{{1,1},{10,15},{11,16}}},
