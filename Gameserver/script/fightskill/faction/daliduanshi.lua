...
local tb	= {
	...
	lingboweibu={ --凌波微步_20
		fastwalkrun_p={{{1,30},{20,70},{21,75}}},
		ignoreskill={{{1,15},{10,40},{20,70},{21,71}},0,{{1,3},{2,3}}},
		state_knock_resistrate={{{1,100},{20,1000},{20,1050}}},
		skill_cost_v={{{1,100},{10,150},{20,300},{21,300}}},
		skill_statetime={{{1,18*5},{20,18*10},{23,18*11}}},
		skill_mintimepercast_v={{{1,40*18},{20,40*18},{21,40*18}}},--ok
		skill_mintimepercastonhorse_v={{{1,40*18},{20,40*18},{21,40*18}}},--ok
		movewithshadow={1},
	},
	cibeijue={ --慈悲诀_10
	...
	miaodizhiqi={ --妙谛指气
		deadlystrikeenhance_r={{{1,50},{10,200},{11,215}}},
		skilldamageptrim={{{1,3},{10,22},{11,24}}},
		skillselfdamagetrim={{{1,3},{10,22},{11,24}}},
		skill_statetime={{{1,18*5},{10,18*5}}},
	},
	zhiduanadvancedbook={ --指段高级秘籍
		appenddamage_p= {{{1,70*0.7},{10,70}}},
	...
	zhiduan120={ --指段120_10
		attackratingenhance_p={{{1,50},{10,125},{11,135}}},
		deadlystrikedamageenhance_p={{{1,5},{10,30},{11,32}}},
		skill_statetime={{{1,-1},{2,-1}}},
	},
	...
	duanshixinfa={ --段氏心法_10
		addcoldmagic_v={{{1,20},{10,400},{11,450}}},
		deadlystrikeenhance_r={{{1,30},{10,50},{11,55}}},
	...
	qiduan120={ --气段120_9_注意,最高等级9级
		appenddamage_p= {{{1,2.2*14*0.7},{9,2.2*14},{10,2.2*14*FightSkill.tbParam.nSadd}}},
		colddamage_v={
			[1]={{1,2.2*500*0.9*0.7},{9,2.2*500*0.9},{10,2.2*500*0.9*FightSkill.tbParam.nSadd}},
			[3]={{1,2.2*500*1.1*0.7},{9,2.2*500*1.1},{10,2.2*500*1.1*FightSkill.tbParam.nSadd}}
			},
		seriesdamage_r={{{1,250},{9,250}}},
		skill_cost_v={{{1,300},{9,300}}},
		state_slowall_attack={{{1,45},{9,50}},{{1,45},{9,45}}},
		missile_hitcount={{{1,4},{2,4}}},
		skill_appendskill2={{{1,232},{10,232}},{{1,1},{10,20},{11,21}}},
		},
}
