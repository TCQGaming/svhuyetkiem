...
local tb	= {
	...
	kunlundaofa={ --昆仑刀法_10
		addphysicsdamage_p={{{1,10},{10,125},{11,135}}},
	...
	kuangfengzhoudian={ --狂风骤电_20
		appenddamage_p= {{{1,85},{20,85},{21,85*FightSkill.tbParam.nSadd}}},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
		physicsenhance_p={{{1,50},{10,100},{20,120},{21,120*FightSkill.tbParam.nSadd}}},
		lightingdamage_v={
	...
	aoxuexiaofeng={ --傲雪啸风
		appenddamage_p= {{{1,95*FightSkill.tbParam.nS1},{10,95},{20,95*FightSkill.tbParam.nS20},{21,95*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
	...
	daokunadvancedbook_child={ --刀昆高级秘籍子_10
		skilldamageptrim	={{{1,1.5},{10,30},{11,31}}},
		skillselfdamagetrim	={{{1,1.5},{10,30},{11,31}}},
		skill_statetime={{{1,18*1},{10,18*1}}},
	},
	daokun120={ --刀昆120_10
	...
	leidongjiutian={ --雷动九天
		appenddamage_p= {{{1,180*FightSkill.tbParam.nS1},{10,180},{20,180*FightSkill.tbParam.nS20},{21,180*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
		lightingdamage_v={
	...
	leitingjue_self={ --雷霆诀_自身
		skilldamageptrim={{{1,5},{10,45},{11,48}}},
	...
	jiankunadvancedbook={ --剑昆高级秘籍_10
		...
		damage_all_resist={{{1,-50},{10,-300},{11,-310}}},
		missile_hitcount={{{1,5},{10,5}}},
	...
	jiankun120_child={ --剑昆120_子_10	
		deadlystrikeenhance_r={{{1,10},{10,35},{11,37}}}, -- chi mang
		lifemax_p={{{1,3},{10,7},{13,8}}},  ---tang sinh luc toi da
		superposemagic={{{1,1},{10,7},{11,7}}}, -- Cộng dồn tối đa
