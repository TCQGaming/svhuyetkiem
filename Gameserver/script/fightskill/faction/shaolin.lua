...
local tb	= {
	...
	shaolindaofa={ --少林刀法_10
		addphysicsdamage_p={{{1,50},{10,220},{11,245}}},
	...
	aluohanshengong={ --阿罗汉神功_20
		meleedamagereturn_p={{{1,10},{10,30},{20,40},{21,41}}},
		rangedamagereturn_p={{{1,10},{10,30},{20,40},{22,43}}},
	},
	aluohanshengong_team={ --阿罗汉神功_队友
		meleedamagereturn_p={{{1,5},{10,5},{20,5},{22,5}}},
		rangedamagereturn_p={{{1,5},{10,5},{20,5},{22,5}}},
	},
	...
	daoshaoadvancedbook = { --刀少高级秘籍_10
		...
		steallifeenhance_p={{{1,-2},{10,-15},{11,-16}},{{1,100},{10,100}}},
	...
	pudugunfa={ --普渡棍法_20
		...
		addskilldamagep3={822, {{1,2},{20,10},{21,12}},1},
	},
	...
	shizihou={ --狮子吼_10
		state_fixed_attack={{{1,35},{10,85},{11,89}},{{1,18*2.5},{20,18*2.5}}},
		state_hurt_attack={{{1,27},{10,54},{11,56}},{{1,18*1.5},{20,18*1.5}}},
		missile_hitcount={{{1,3},{10,6},{11,6}}},
	...
	fumogunfa={ --伏魔棍法_20
		...
		addskilldamagep2={822, {{1,2},{20,30},{21,35}},1},
	},
	...
	qixingluoshagun={ --Skill9x: That Tinh La Sat Con
		appenddamage_p= {{{1,45*0.7},{20,45},{21,45*FightSkill.tbParam.nSadd}}},
		physicsenhance_p={{{1,82*0.7},{20,82},{21,82*FightSkill.tbParam.nSadd}}},
		physicsdamage_v={
			[1]={{1,375*0.9*0.7},{20,375*0.9},{21,375*0.9*FightSkill.tbParam.nSadd}},
			[3]={{1,375*1.1*0.7},{20,375*1.1},{21,375*1.1*FightSkill.tbParam.nSadd}}
			},
		skill_cost_v={{{1,100},{20,100}}},
		seriesdamage_r={{{1,250},{20,250}}},
		missile_hitcount={{{1,1},{20,1}}},
		skill_appendskill={{{1,33},{20,33}},{{1,1},{20,20},{21,21}}},
	},
	qixingluoshagun_child={ --棍少120_子_10
	lifereplenish_p={{{1,0},{10,0},{11,2},{20,20},{21,22}}},
	...
	zuibaxiangun={ --skill 110: tuy bat tien con
		state_drag_attack={{{1,35},{10,85},{11,89}},{{1,14},{10,14},{11,14}},{{1,32},{2,32}}},
		state_fixed_attack={{{1,35},{10,85},{11,89}},{{1,18*2.5},{10,18*2.5}}},
		appenddamage_p= {{{1,300*FightSkill.tbParam.nS1},{10,300},{20,300*FightSkill.tbParam.nS20},{21,300*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
		physicsenhance_p={{{1,350*FightSkill.tbParam.nS1},{10,350},{20,350*FightSkill.tbParam.nS20},{21,350*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
		physicsdamage_v={
	...
	zuibaxiangun_child={ --中级秘籍：金刚不坏
		state_drag_attack={{{1,35},{10,80},{11,82}},{{1,14},{10,19},{11,20}},{{1,32},{2,32}}},
		state_fixed_attack={{{1,35},{10,65},{11,68}},{{1,18*2.5},{10,18*2.5}}},
	},
	...
	gunshao120={ --Skill 120: Ma Kha Vô Lượng

		appenddamage_p= {{{1,50*FightSkill.tbParam.nS1},{10,50},{20,50*FightSkill.tbParam.nS20},{21,50*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd1}}},
		...
		physicsdamage_v={
			[1]={{1,525*0.9*FightSkill.tbParam.nS1},{10,525*0.9},{20,525*0.9*FightSkill.tbParam.nS20},{21,525*0.9*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd1}},
			[3]={{1,525*1.1*FightSkill.tbParam.nS1},{10,525*1.1},{20,525*1.1*FightSkill.tbParam.nS20},{21,525*1.1*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd1}}
			},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
		skill_cost_v={{{1,45},{20,90},{21,90}}},
		state_hurt_attack={{{1,10},{10,20},{20,25}},{{1,18},{20,18}}},
