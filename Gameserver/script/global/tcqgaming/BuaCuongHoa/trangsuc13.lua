local tbItem	= Item:GetClass("trang_suc13");
tbItem.nNumCuong = 13;
...
function tbItem:CuongHoa(tbItemObj)
    ...
    for i = 1, #tbItemObj do 
		...
		if (nLevel < 10) and (CheckItem.nRefineLevel < 1) then-- 炼化1级的才能强16
	...
	local nTonch = me.GetTask(3031,1)
	me.SetTask(3031,1,nTonch + 1)
