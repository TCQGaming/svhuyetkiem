...
local KnbBiz = Item:GetClass("banhchungvuahung");

KnbBiz.Level_Exp = 129;

function KnbBiz:OnUse()	
--DoScript("\\script\\global\\tcqgaming\\npc\\event\\giotohungvuong\\banhchungvuahung.lua");
...
local SoLuongSuDung = me.GetTask(9156,43)
if SoLuongSuDung >= 500 then 
me.Msg("Bạn đã sử dụng<color=yellow>tối đa 500 Bánh Chưng Vua Hùng<color> rồi<color>");
return 0
end
    local nNeedBag = 15;
...
me.AddStackItem(18,1,1303,5,nil,1)---Rương ngọc cấp 5
me.AddStackItem(22,1,81,1,nil,1);--Tần lăng hòa thị ngọc thô
KDialog.MsgToGlobal("<color=yellow>Người chơi <color=cyan>[ "..me.szName.." ]<color> đã sử dụng Bánh Chưng Vua Hùng 500 Lần xin chúc mừng<color><color=gold>\nPhần Thường :\n1 Rương Ngọc Lấp Lánh Cấp 5\n1 Hòa Thị Ngọc(thô)\n2 Lệnh Bài Triệu Hồi Boss TDC\n1 Huyền Tinh Cấp 8\n1Huyền Tinh Cấp 9\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n100 Tiền Du Long\n500 Triệu Kinh Nghiệm");
end
if ngaunhien == 1 then
...
me.SetTask(9156,43, DemSoLuong)
me.Msg("Bạn đã sử dụng <color=gold>"..DemSoLuong.." lần Bánh Chưng Vua Hùng<color>");
