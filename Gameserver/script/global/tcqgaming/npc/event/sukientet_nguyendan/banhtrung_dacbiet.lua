--Tết Âm Lịch 2025
--TCQGaming - 18/01/2025

local tbItem = Item:GetClass("banhchung_2024");

tbItem.Level_Exp = 109;

function tbItem:OnUse()
-- DoScript("\\script\\global\\tcqgaming\\npc\\event\\sukientet_nguyendan\\banhtrung_dacbiet.lua");
...
local SoLuongSuDung = me.GetTask(9178,63)

if SoLuongSuDung >= 1000 then 
me.Msg("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng tối đa<color=yellow> 1000 Bánh Chưng Tết 2025 <color>rồi<color>");
return 0
end
...
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow>Bánh Trưng Đặc Biệt 2025<color> 50 lần <color=gold>\nPhần Thường : \n2 Huyền Tinh Cấp 7\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n50 Tiền Du Long");
end
...
me.AddBindCoin(150000);	-- 15v đồng khóa
me.AddStackItem(18,1,553,1,{bForceBind=1},50)--25-Tiền Du Long
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow>Bánh Trưng Đặc Biệt 2025<color> 150 lần<color=gold>\nPhần Thường : \n2 Huyền Tinh Cấp 7\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n50 Tiền Du Long");
end 
...
me.AddBindCoin(150000);	-- 15v đồng khóa
me.AddStackItem(18,1,553,1,{bForceBind=1},50)--25-Tiền Du Long
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow>Bánh Trưng Đặc Biệt 2025<color> 300 lần<color=gold>\nPhần Thường : \n2 Huyền Tinh Cấp 7\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n50 Tiền Du Long");
end
...
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow> Bánh Trưng Đặc Biệt 2025<color> 500 lần<color=gold>\nPhần Thường : \n4 Huyền Tinh Cấp 7\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n100 Tiền Du Long");
...
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow> Bánh Trưng Đặc Biệt 2025<color> 600 lần<color=gold>\nPhần Thường : \n1 Huyền Tinh Cấp 8\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n200 Tiền Du Long");
...
me.AddBindCoin(150000);	-- 15v đồng khóa
me.AddStackItem(18,1,553,1,{bForceBind=1},200)---Tiền Du Long
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow> Bánh Trưng Đặc Biệt 2025<color> 700 lần<color=gold>\nPhần Thường : \n1 Huyền Tinh Cấp 8\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n200 Tiền Du Long");
...
me.AddBindCoin(150000);	-- 15v đồng khóa
me.AddStackItem(18,1,553,1,{bForceBind=1},200)---Tiền Du Long
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow> Bánh Trưng Đặc Biệt 2025<color> 800 lần<color=gold>\nPhần Thường : \n1 Huyền Tinh Cấp 8\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n200 Tiền Du Long");
...
me.AddBindCoin(150000);	-- 15v đồng khóa
me.AddStackItem(18,1,553,1,{bForceBind=1},200)---Tiền Du Long
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ] Bạn đã sử dụng <color=yellow> Bánh Trưng Đặc Biệt 2025<color> 900 lần<color=gold>\nPhần Thường : \n1 Huyền Tinh Cấp 8\n15 Van Bạc Khóa\n15 Vạn Đồng Khóa\n200 Tiền Du Long");
...
me.AddStackItem(18,1,2034,22,nil,1)---Bánh Chưng Tiềm Năng
me.AddStackItem(18,1,2025,12,{bForceBind=1},10)--LB Đồ Hải Tặc cấp 3
KDialog.MsgToGlobal("<color=yellow>Người chơi <color=cyan>[ "..me.szName.." ]<color> đã sử dụng tối đa 1000 lần Bánh Trưng Đặc Biệt 2025 xin chúc mừng<color><color=gold>\nPhần Thường : \n1 Bánh Trưng Tiềm Năng\n1 Huyền Tinh Cấp 10\n150 Rương TB Đồng hành\n15 Van Bạc Khóa\n150 Vạn Đồng Khóa\n800 Tiền Du Long\n10 Lệnh bài đồ Hải tặc cấp 3\n1 Bổ Tu Lệnh Khóa");
...
KDialog.MsgToGlobal("<color=green>Người chơi <color=yellow>[ "..me.szName.." ]<color>đã sử dụng <color=yellow>Bánh Chưng Tết 2025 đã may mắn nhận được<color><color=gold>\n 1 Huyền Tinh 5");
...
me.SetTask(9178,63, DemSoLuong)
me.Msg("Bạn đã sử dụng <color=gold>"..DemSoLuong.." Bánh Chưng Tết 2025<color>");
