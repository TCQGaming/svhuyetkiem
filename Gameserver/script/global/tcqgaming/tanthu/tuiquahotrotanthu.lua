...
local tbItem = Item:GetClass("tuiquahotrotanthuday"); 
...
tbItem.nWeaponLevel		= 8;					-- Vũ Khí
tbItem.nArmor_Level		= 8;					-- Trang Bị
tbItem.CuongHoa			= 10; 					-- cường hóa trang bị 
tbItem.CuongHoa1			= 10; 					-- cường hóa trang bị với vũ khí

function tbItem:AddItem()
local tbItemId = {18,1,2105,9,0,0}
