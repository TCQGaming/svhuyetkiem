...
function tb:ObtainMemberPos(nMemberPlayerId, nPlayerId, nItemId, nMapId, nPosX, nPosY, nFightState)
	...
	if 	(nMapId == 1737) or (nMapId == 1738)or (nMapId == 1739) or (nMapId == 1740) or (nMapId == 1741) or (nMapId == 1540) or (nMapId == 1721) then
		pPlayer.Msg("<color=blue>Nơi Này Không Thể Đến<color>");
		return 0;
	end
	if nMapId == -1 then
