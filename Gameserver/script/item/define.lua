...
Item.EQUIPPOS_NAME =
{
	...
	[Item.EQUIPPOS_ZHENYUAN_SUB1] = "Bí Bảo",		-- <-Change
...
Item.TIP_SERISE = 
{
	"<color=yellow>Môn phái hệ Kim<color>", 
	"<color=green>Môn phái hệ Mộc<color>", 
	"<color=blue>Môn phái hệ Thủy<color>", 
	"<color=red>Môn phái hệ Hỏa<color>", 
	"<color=gray>Môn phái hệ Thổ<color>",
};
...
--SoulSignet Add
Item.MIN_SOULSIGNET_LEVEL		= 1;
Item.tbMAX_SOULSIGNET_LEVEL =
{
	[1] = {
		[1] = 400,
		[2] = 400,
