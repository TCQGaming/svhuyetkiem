...
MAX_TIMES			= 14 	-- 最多累计次数
MIN_TEAM_PLAYERS	= 1		-- Tổ Đội (Số lượng người trong đội)
MIN_LEVEL			= 80	-- 最低等级
MAX_TEAM			= 8		-- 闯关最大队伍数
...
MAX_REPUTE_TIMES	= 2000	-- nộp điểm tdc số lượng
START_TIME1			= 0800	-- 开启时间1
END_TIME1			= 2359	-- 关闭时间1
START_TIME2			= 0000	-- 开启时间2
END_TIME2			= 0759	-- 关闭时间2
