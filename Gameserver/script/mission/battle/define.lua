...
Battle.TIME_DEATHWAIT	= 10;	-- Thời gian ra khỏi doanh trại
...
Battle.LEVEL_LIMIT	= { 50, 90, 251 };		-- 进不同战场需要的等级
...
Battle.BTPLNUM_HIGHBOUND	= 250;									-- so luong nguoi choi moi ben
Battle.BTPLNUM_NUMDIF		= 1;									-- chenh lech
Battle.BTPLJUNXUDIAN		= 3;								 	-- 领取军需次数
Battle.BTPLJUNXUTIMEOUT		= 24 * 60 * 60 * 7;						-- 军需使用时限,按天数算
Battle.BTPLWEIWANGLIMIT		= 30;									-- 威望周最大值
Battle.BOUNS2EXPMUL			= 1;
...
Battle.POINT_ADD_MAP	= {
	[Battle.RESULT_WIN]		= 600,									-- Thắng
	[Battle.RESULT_TIE]		= 600,									-- Hòa
	[Battle.RESULT_LOSE]	= 600,									-- Thua 
};

Battle.POINT_LIMIT_MAP = { 100000, 100000, 100000 };
...
Battle.TSK_BTPLAYER_BOUNSNEW		= 19;
Battle.Mission_Battle_HardWare_Folder = "\\script\\mission\\battle\\"; -- Đường dẫn folder Ổ cứng
Battle.Mission_Battle_HardWare_List = "list.txt"; -- Đường dẫn folder Ổ cứng
Battle.Mission_Battle_CheckNumAccount = 1;
