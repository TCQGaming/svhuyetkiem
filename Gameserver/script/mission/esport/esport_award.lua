...
function Esport:AwardSingleWin(pPlayer)
	...
	pPlayer.Msg("Chúc mừng đội của bạn giành chiến thắng")
	self:WriteLog("Chúc mừng đội của bạn giành chiến thắng", pPlayer.nId);
end
...
function Esport:AwardSingleLost(pPlayer)
	...
	pPlayer.Msg("Thật không may, đội của bạn đã bị loại, kiễn nhẫn chờ đợi.")
	self:WriteLog("Thật không may, đội của bạn đã bị loại, kiễn nhẫn chờ đợi.", pPlayer.nId);
end
...
function Esport:AwardSingleTie(pPlayer)
	...
	pPlayer.Msg("Thật không may, đội của bạn hòa , kiễn nhẫn chờ đợi")
	self:WriteLog("Thật không may, đội của bạn hòa , kiễn nhẫn chờ đợi", pPlayer.nId);
end
