...
Wlls.DEF_STATE_MSG = {
	[Wlls.DEF_STATE_CLOSE]		= "Trạng thái mở",
	[Wlls.DEF_STATE_REST]		= "Giải lao",
	[Wlls.DEF_STATE_MATCH]		= "Thời gian thi đấu",
	[Wlls.DEF_STATE_ADVMATCH]	= "Thời gian thi đấu bát cường liên đấu cao cấp",
};
...
Wlls.LGTASK_MTYPE	= 2;		--the thuc thi dau lien dau
...
Wlls.MACTH_LEAGUE_MIN			= 2;		--准备场中最少要有多少队才能开启。
Wlls.MACTH_ATTEND_MAX			= 48;		--每个战队最多参加多少场
Wlls.MACTH_ADV_START_MISSION 	= 1;		--高级联赛开启届数。第三届才开启高级联赛; mac dinh 3
...
{
	[Wlls.MACTH_PRIM] 	= "Sơ cấp",	--外围赛
	[Wlls.MACTH_ADV]	= "Cao cấp",	--精英赛
};
...
--比赛场参数
Wlls.MACTH_TIME_READY 			= Env.GAME_FPS * 280;		--Thời gian chuẩn bị Env.GAME_FPS * 280;
Wlls.MACTH_TIME_READY_LASTENTER = Env.GAME_FPS * 5;			--Không được phép nhập cảnh trong 5 giây qua;
Wlls.MACTH_TIME_PK_DAMAGE 		= Env.GAME_FPS * 5;			--Thời gian sát thương đồng bộ;
Wlls.MACTH_TIME_UPDATA_RANK 	= Env.GAME_FPS * 610;		--Thời gian cập nhật bảng xếp hạng sau khi hết thời gian chuẩn bị là bao lâu?;

Wlls.MACTH_TIME_ADVMATCH 		= Env.GAME_FPS * 900;		--Thời gian nghỉ giữa mỗi hiệp của tứ kết;
Wlls.MACTH_TIME_ADVMATCH_MAX 	= 5;						--Tổng số trận tứ kết, 5 trận;

Wlls.MACTH_TIME_RANK_FINISH 	= Env.GAME_FPS * 60;		--Người ta ước tính rằng thời gian xử lý cần thiết cho thứ hạng cuối cùng trước khi người chơi có thể nhận được phần thưởng
Wlls.MACTH_TIME_CLEARLEAGUE 	= Env.GAME_FPS * 240;		--Khi nào dự kiến ​​sẽ xóa nhóm người chơi
...
Wlls.MIS_UI 	= 
{
	[1] = {"<color=gold>%s Vs %s\n\n", "<color=green>Thời gian thi đấu bắt đầu còn: <color=white>%s<color>\n\n", "<color=green>Đối phương bị thương: <color=red>%s\n<color=green>Phe bạn bị thương: <color=blue>%s"};
	[2] = {"<color=gold>%s Vs %s\n\n", "<color=green>Còn: <color=white>%s<color>\n\n", "<color=green>Đối phương bị thương: <color=red>%s\n<color=green>Phe bạn bị thương: <color=blue>%s"};
}
Wlls.MIS_UI_LOOKER = "<color=green>%s sinh lực:<color=red>\n    %s\n\n<color=green>%s sinh lực:\n    <color=blue>%s";
