...
function tbItem:OnUse()
	...
	me.AddSkillState(385, 10, 1, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
	me.AddSkillState(386, 10, 1, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
	me.AddSkillState(387, 10, 1, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
	me.AddSkillState(880, 5, 1, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
