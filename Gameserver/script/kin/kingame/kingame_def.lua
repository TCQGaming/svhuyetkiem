...
local preEnv = _G	--bảo vệ môi trường cũ
setfenv(1, KinGame)	--Đặt môi trường hiện tại thành Kin

MAX_WEEK_DEGREE	= 2;		-- Số tuần tối đa
...
MAX_GAME 				= 30;		-- số bản sao tối đa của một thành phố
MIN_PLAYER				= 1;		-- Số người tối thiểu tham gia phó bản mặc định 6
TASK_GROUP_ID 			= 2028;		-- Nhóm biến nhiệm vụ đấu trường
TASK_BAG_ID 			= 1; 		-- Biến nhiệm vụ túi tiền
TASK_USED_NUM			= 2;
TASK_WEEK_ID			= 3;
MAX_MIYAO_LIMIT_ITEM 	= 3; 		-- Số lượng tối đa của mỗi loại thuốc được sinh ra 
MAX_BAOXIANG 			= 5; 		-- Số lượng rương kho báu bằng đồng xu tối đa có thể được sinh ra trong mỗi phòng
NPCID_BAOXIANG 			= 2960; 	-- Id rương kho báu đồng xu
MAX_GUQIANBI			= 1000;		-- Khả năng lưu trữ tối đa của tiền cổ
KIN_REPUTE_CAMP			= 4;
KIN_REPUTE_CALSS		= 1;
KEY_ITME_TIME			= 10;
PAY_GUQIANBI			= 5;		--Quay trở lại những đồng xu cổ cần thiết trong phòng lựa chọn

GOU_HUN_YU_COST			= {50, 150, 300}; 	-- Số bạc cổ đổi lấy ngọc săn hồn

GOU_HUN_YU_ITEM			= {18,1,146}		-- Ám ảnh ngọc đạo cụ
OPEN_KEY_ITEM = {18, 1, 106, 1, {bForceBind = 1, bTimeOut = 1}} 	-- đạo cụ chính chìa khóa cửa địa cung
