...
CHANGE_ASSISTANT_TIME 	= 1 			--thay đổi phó tộc trưởng khoảng cách 
QUIT_TONG_TIME 			= 1 * 3600 	-- khởi xướng rời khỏi bang hội đích hưởng ứng thời gian 
GET_EXP_BEGIN_TIME 		= 19 * 60 + 30		-- gia tộc lĩnh kinh nghiệm lúc bắt đầu đang lúc （tương đối 0điểm đích phút sổ ）
GET_EXP_END_TIME 		= 23 * 60 + 30		-- gia tộc lĩnh kinh nghiệm kết thúc thời gian 
CANCEL_RETIRE_TIME		= 1 * 3600		-- gia tộc thủ tiêu thoái ẩn đích thời gian 
CHANGE_REGULAR_TIME		= 2 * 24 * 3600		-- ngoạn gia từ ký danh đáo chuyển chính thức đích thời gian 
KIN_RECRUITMENT_PUBLISH_TIME	= 7 * 24 * 3600	-- gia tộc chiêu mộ kéo dài nhỏ nhất thời gian 
MEMBER_LEAVE_TIME = 1
