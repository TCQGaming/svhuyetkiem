...
--Ghi lại dữ liệu tạm thời của tập lệnh gia đình
...
function Kin:GetKinData(nKinId)
	...
	--Ghi lại các sự kiện được đề xuất
	aKinData.aIntroduceEvent = {}	
	aKinData.aIntroduceCancel = {}
	--Ghi nhật ký các sự kiện phản hồi kick
	aKinData.aKickEvent = {}
	if MODULE_GC_SERVER then
	else
		--mời bộ đệm thành viên
		aKinData.aInviteEvent = {}
		--Bộ nhớ cache của tổng giá trị uy tín gia đình
		aKinData.nTotalRepValue = 0
		--Tổ phụ nhận được một bộ đệm giá trị bổ sung
...
--Đánh giá thẩm quyền của người thi hành công vụ
--nFigureLevel：Mức nào có thể được vận hành ở trên
