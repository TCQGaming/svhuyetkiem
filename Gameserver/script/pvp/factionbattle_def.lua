...
MIN_RESTART_MELEE			= 2;		-- ít nhất phân tràng nhân số 	
...
FLAG_X						= 1562;		-- quán quân cờ tọa độ 
FLAG_Y						= 3394;		-- quán quân cờ tọa độ 
...
ELIMINATION_TASK_ID			= 5;		-- task thưởng top loạn phái
...
--  状态      定时时间    时间到回调函数(函数返回0表示不在继续定时，结束活动)
 {SIGN_UP,     30 * 60,     "StartMelee"  },  -- 报名定时, goc 30
 {MELEE,     4 * 60,     "RestartMelee"  },  -- 混战定时, goc 5
 {MELEE,     4 * 60,     "RestartMelee"  },  -- 混战定时, goc 5
 {MELEE,     4 * 60,     "RestartMelee"  },  -- 混战定时, goc 5
-- {MELEE,     6 * 60,     "RestartMelee"  },  -- 混战定时
 {MELEE,     4 * 60,     "EndMelee"   }, -- , goc 5
 {READY_ELIMINATION,  1 * 60,     "StartElimination" },   -- 淘汰赛准备
 {ELIMINATION,   4 * 60,     "EndElimination" },   -- 淘汰赛1阶 决出8强 --goc3
 {READY_ELIMINATION,  2 * 60,     "StartElimination" },   -- 淘汰赛准备
 {ELIMINATION,   4 * 60,     "EndElimination" },   -- 淘汰赛2阶 决出4强--goc3
 {READY_ELIMINATION,  2 * 60,     "StartElimination" },   -- 淘汰赛准备
 {ELIMINATION,   4 * 60,     "EndElimination" },   -- 淘汰赛3阶 决出2强--goc3
 {READY_ELIMINATION,  2 * 60,     "StartElimination" },   -- 淘汰赛准备
 {ELIMINATION,   4 * 60,     "EndElimination" },   -- 淘汰赛4阶 冠军--goc3
 {CHAMPION_AWARD,  1 * 60,    "EndChampionAward" },   -- 冠军奖励
 {END}
};
