...
QianCengTower.TASK_TODAY_JOIN_COUNT	= 1; 	-- 今日还可参加的次数
QianCengTower.TASK_OPEN_MAPID		= 2;	-- 地图开启id
QianCengTower.TASK_OPEN_TIME		= 3;	-- 地图开启时间
QianCengTower.TASK_ROOM_NUM_SAVE	= 4;	-- 保存副本进度
...
QianCengTower.TASK_UPDATE_JOIN_COUNT_TIME = 9;	-- 玩家免费次数刷新时间
QianCengTower.TASK_OPEN_ROOM_NUM 	= 10;	-- 开启副本层数
QianCengTower.TASK_PLAYER_REVIVE_COUNT = 11; -- 玩家复活次数
QianCengTower.TASK_FAN_PAI_COUNT	= 12; -- 玩家额外抽奖次数
...
QianCengTower.NPC_ID_YAOSHANG		= 11585;
...
QianCengTower.DEF_TIME_10_STEP_REST		= Env.GAME_FPS * 60 * 1;
...
QianCengTower.MAX_LADDER_NUM = 20;
