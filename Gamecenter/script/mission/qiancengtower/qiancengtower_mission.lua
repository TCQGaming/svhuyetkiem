...
RoomBaseMission.tbStarSkill				= {
		[RoomBaseMission.DEF_NPC_TYPE_STAR_DAMAGE1] = 1786,
		[RoomBaseMission.DEF_NPC_TYPE_STAR_DAMAGE2] = 2245,
		[RoomBaseMission.DEF_NPC_TYPE_STAR_BUFF]	= 1080,
	};
...
QianCengTower.tbClearSkillId = {1786, 2245, 1080, 999};
...
function RoomBaseMission:AddYaoShangAndYeLianDaShi(nCurRoomNum)
	...
	local tbNormalPosList = self:GetNpcAddPos(tbRoomInfo.nTempMapId, self.DEF_NPC_TYPE_BOSS)
	local tbNpcPos	= tbNormalPosList[3][1]
	KNpc.Add2(QianCengTower.NPC_ID_YAOSHANG, 1, -1, self.nGameMapId, tbNpcPos[1], tbNpcPos[2]);
