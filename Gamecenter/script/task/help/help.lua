...
function tbHelp:_AddMoneyUseNews()
	...
	if (nAddFlag == 1) then
		...
		local szMsg		= "Cách có được bạc không khóa trong Kiếm Thế Vn by KeBacTinh86 0973.212.767 :\nHoàn thành <color=yellow>Nhiệm vụ nghĩa quân<color> và có <color=yellow>bản đồ kho báu<color>.\n\n" .. 
						"<color=yellow>Kiếm Thế Vn by KeBacTinh86 0973.212.767 Nhiệm vụ nghĩa quân<color>\nNhận ở chỗ Bao Vạn Đồng tại Thành thị và Tân Thủ Thôn, hoàn thành 10 nhiệm vụ sẽ nhận được khoảng <color=yellow>10000<color> bạc không khóa.\n\n" .. 
						"<color=yellow>Bản đồ kho báu<color>\nHoàn thành 10 Nhiệm vụ nghĩa quân mỗi ngày sẽ nhận được 1 Bản đồ kho báu, đào tại nơi chỉ định theo thuyết minh trên bản đồ, sẽ nhận được bạc không khóa và có thể đào ra mê cung, hoàn thành sẽ được <color=yellow>100000 hoặc 120000 bạc không khóa<color>.Kiếm Thế Vn by KeBacTinh86 0973.212.767 \n";
