...
function Marry:StartEvent()
	...
	local nTaskId = 0;
 	...
 	nTaskId = KScheduleTask.AddTask("Mo Hoat Dong Hon Le Hang Ngay", "Marry", "StartWedding_GC");
	KScheduleTask.RegisterTimeTask(nTaskId, 1200, 1);
	
	nTaskId = KScheduleTask.AddTask("Dong  Hoat Dong Hon Le Hang Ngay", "Marry", "CloseWedding_GC");
