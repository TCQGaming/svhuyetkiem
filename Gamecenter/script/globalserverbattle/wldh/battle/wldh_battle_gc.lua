...
function tbBattle:StartEvent()
	...
	local nTaskId;
 	...
 	nTaskId = KScheduleTask.AddTask("Dai Hoi Vo Lam Phan Doi", "Wldh", "FinalGroup_1");
	KScheduleTask.RegisterTimeTask(nTaskId, 1920, 1);
	
	nTaskId = KScheduleTask.AddTask("Dai Hoi Vo Lam Doan The Tran Chung Ket", "Wldh", "FinalStart_1");
	KScheduleTask.RegisterTimeTask(nTaskId, 1930, 1);
	
	nTaskId = KScheduleTask.AddTask("Dai Hoi Vo Lam Phan Doi", "Wldh", "FinalGroup_2");
	KScheduleTask.RegisterTimeTask(nTaskId, 2050, 1);
	
	nTaskId = KScheduleTask.AddTask("Dai Hoi Vo Lam Doan The Tran Chung Ket", "Wldh", "FinalStart_2");
