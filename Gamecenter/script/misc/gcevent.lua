...
function GCEvent:CozoneFactionElecet_Merge()
	for nFaction = 1, 12 do
		...
		if nCount > FactionElect.KD_FACTION_CANDIDATE_MAX then
			...
			print("Mon Phai "..nFaction.."Sat nhap thang truoc nguoi ung cu di thuong，Sat nhap sau so lieu lon hon chua dung vi tri, binh thuong sat nhap truoc 30, liet bieu nhu sau")
		...
		if nCount > FactionElect.KD_FACTION_CANDIDATE_MAX then
			nCount = FactionElect.KD_FACTION_CANDIDATE_MAX;
			print("Mon Phai "..nFaction.."Sat nhap thang nay nguoi ung cu di thuong，Sat nhap sau so lieu lon hon chua dung vi tri, binh thuong sat nhap truoc 30, liet bieu nhu sau")
		...
		--print("Mon Phai "..nFaction.."本月合并完成,结果如下:")
		...
		if nCount > FactionElect.KD_FACTION_DATA_SEGMENT_LENGTH then
			...
			print("Mon Phai "..nFaction.."Sat nhap ky truoc dai su huynh di thuong，Sat nhap sau so lieu lon hon chua dung vi tri, binh thuong sat nhap truoc 1000, liet bieu nhu sau")
		...
		--print("Mon Phai "..nFaction.."历届合并完成,结果如下:")
