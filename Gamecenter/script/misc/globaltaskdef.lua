...
GBLINTBUF_INIVITE_PLAYERLIST 	= 101;	--邀请老玩家
GBLINTBUF_Repair_ZhuanZhuanLe	= 	102; -- 台湾版修复变量占位
GBLINTBUF_GBCOSTCOIN	= 103;	--全局服玩家消耗金币记录
GBLINTBUF_JXSJ_KEJU_SUB 		= 104;	--从服科举考试记录(编号用错，这里校正一次，请后续童鞋用上面未用的id)
GBLINTBUF_PRAY2013_LIST	= 105;	-- 13年新年活动祈愿玩家列表
GBLINTBUF_MINE_WAR_SIGNUP = 106; -- 报名buf
GBLINTBUF_MINE_WAR_LASTRESULT = 107; -- 跨服争夺保存上届最佳帮会
GBLINTBUF_DEVWEAPON_LIST = 108;	-- 白金武器排行榜每天前10武器信息列表
GBLINTBUF_DEV_LADDER_WEEK_LEADER = 109;	-- 白金武器排行榜每周第一名列表
GBLINTBUF_EVENT_LADDER = 110; -- 活动排行榜数据
GBLINTBUF_KIN_BATTLE_LADDER = 111; -- 金牌家族争霸赛对阵表
GBLINTBUF_TASKFINISH		= 	112;	-- 任务发布平台完成的任务
GBLINTBUF_FIRSTLOGIN_FROMGLBSERVER = 113; -- 玩家在去全局服后，第一次在本服上线触发事件(主要用于同步全局服任务变量)
GBLINTBUF_DEV_LADDER_WEEK_LEADER_SUB = 114; -- 武器排行榜从服保存
GBLINTBUF_NEW_LOTTORY_NEW_BUFFER = 115; -- 充值促销新buffer
GBLINTBUF_HONOR_PLAYERLIST	 = 117; --超神披风暂定的名单
GBLINTBUF_JXSJ_KEJU 	= 258;	--科举考试(编号用错，这里校正一次，请后续童鞋用上面未用的id)
GBLINTBUF_Tong_Vote201110	= 	20000;	-- 帮会选举201110
GBLINTBUF_VN_EVENT_1		=	20001;	-- 越南活动专用
GBLINTBUF_VN_KE_LUCKY_AWARD	=	20002;	-- 幸运转盘
GBLINTBUF_VN_MONTHLY_CFG	=	20003;	-- 越南月度活动
GBLINTBUF_Tong_Vote201204	= 	20004;	-- 帮会选举201204
GBLINTBUF_VN_EVENT_2		=	20005;	-- 越南活动专用
GBLINTBUF_VN_SHOP_CFG		=	20006;	-- 越南代币商店
GBLINTBUF_VN_NPTRANSFER		=	20007;	-- 越南新玩家转服活动
GBLINTBUF_VN_TASKPLATFORM	=	20008;	-- 越南精活任务发布平台撤销的任务
GBLINTBUF_VN_TRANSFER		=	20009;	-- 越南转服后限制转服的玩家列表
GBLINTBUF_VN_HDPARTY		=	20010;	-- 越南花灯晚会活动
GBLINTBUF_VN_GUIYUAN		=	20011;	-- 越南归元系统排行榜
GBLINTBUF_VN_LOGINNOTIFY	= 20012;		-- 上线通知消息
GBLINTBUF_VN_WOMAN_LOTTERY  =   20013;  -- 越南妇女节幸运抽奖
GBLINTBUF_VN_TIANZIYU		= 20014;	-- 越南天子屿相关
GBLINTBUF_VN_BUYACTIVE		= 20015;	-- 记录金币购买活跃度的开始和结束时间
GBLINTBUF_VN_VALUEITEM		= 20016;	-- ke上传的关键道具列表
GBLINTBUF_VN_FIXNEWLAND		= 20017;	-- ke上传的跨服城战经验修复玩家列表
GBLINTBUF_VN_TIANXINSHI		= 20018;	-- 天龙令系统开关信息
GBLINTBUF_VN_KINHONOR		= 20019;	-- 越南百大家族积分排行榜

DBTASD_UPDATE_TRUUYDANH 		= 20044;
DBTASD_UPDATE_VSV 		= 20045;
DBTASD_UPDATE_RuongVuaDepVuaCaoQuy 		= 20046;
DBTASD_UPDATE_DuaTOPToanSeverT6 		= 20047;
DBTASD_UPDATE_GioiHanVanTieu 		= 20048;
DBTASD_UPDATE_TichLuyLenhBai_VuKhiHaiTac 		= 20049;
DBTASD_UPDATE_RuongCongThanh 		= 20050;
DBTASD_UPDATE_MUALAIHOATDONGNVHN 		= 20051;
DBTASD_CongThanhTruPhuongTuong 		= 20052;
DBTASD_CongThanhTruBienKinh 		= 20053;
DBTASD_CongThanhTruLamAn 		= 20054;
DBTASD_CongThanhTruDuongChau 		= 20055;
DBTASD_CongThanhTruThanhDo 		= 20056;
DBTASD_CongThanhTruTuongDuong 		= 20057;
DBTASD_CongThanhTruDaiLy 		= 20058;
DBTASD_THUONGNHAN_VSV 		= 20059;
DBTASD_GIOIHANLUANVODAI 		= 20060;
...
DBTASD_SERVER_SETMAXLEVEL109	= 78; 	-- Giới hạn cấp độ 109
DBTASD_SERVER_SETMAXLEVEL129	= 202; 	-- Giới hạn cấp độ 129
DBTASD_SERVER_SETMAXLEVEL139	= 203; 	-- Giới hạn cấp độ 139
DBTASD_SERVER_SETMAXLEVEL150 = 78 --记录开启150级时间(格式:GetTime); 
DBTASD_SERVER_SETMAXLEVEL165 = 262 --记录开启150级时间(格式:GetTime); 
DBTASD_SERVER_SETMAXLEVEL180 = 263 --记录开启150级时间(格式:GetTime); 
...
DBTASK_DOMAINTASK_OPENTIME = 123;		-- Mở cửa nhiệm vụ mở ra thời gian điểm -- by zhangjinpin@kingsoft
...
DBTASK_VN_EVENT_1					= 177;	-- 越南活动专用
DBTASK_VN_EVENT_2					= 178;	-- 越南活动专用
DBTASK_VN_EVENT_3					= 179;	-- 越南活动专用
DBTASK_VN_EVENT_4					= 180;	-- 越南活动专用
DBTASK_VN_EVENT_5					= 181;	-- 越南活动专用
DBTASK_VN_EVENT_6					= 182;	-- 越南活动专用
...
DBTASK_VN_TASKID_VERSION			= 189;	-- 越南活动（177-182）重用批次
...
DBTASD_TONGKIM_SOTRAN			= 148;
DBTASD_FLASHSALE_SLITEM			= 149;
DBTASD_FOLLOWUID_SV					= 272; 	-- Theo Dõi Uy Danh Toàn Server
DBTASD_FOLLOW_TRUNG_SV				= 275; 	-- Theo Dõi Rương TRỨNG Toàn Server
...
DBTASK_GLOBAL_NEWLAND_CITYER8	= 253;	-- 铁浮城主8号战区
DBTASK_GLOBAL_NEWLAND_CITYER9	= 254;	-- 铁浮城主9号战区
DBTASK_INIVITE_OTHERAWARD	= 255;	-- 老玩家邀请额外奖励
DBTASK_ZHOUNIANQING2012_BIGGOLD_HONOR_DAY	= 256;	-- 周年庆天记录
DBTASK_ZHOUNIANQING2012_BIGGOLD_HONOR_COUNT	= 257;	-- 周年庆小牌子记录
DBTASK_JXSJ_KEJU_WEEKGRADE	= 258;	-- 科举考试
DBTASK_MINEWAR_AWARD_FLAG	= 259;	-- 跨服争夺中领奖标记,0表示不能领奖，1表示领奖
DBTASK_MINEWAR_BATTLE_STATE	= 260;	-- 跨服争夺中领奖标记,0表示不能领奖，1表示领奖
DBTASK_PLATINUM_WEAPON_DAY	= 261;	-- 白金武器开放时间
DBTASK_VN_GLBBUFFER_VERSION		= 	20000;	-- 越南活动专用, 清除GlbBuffer版本标志
DBTASK_VN_IPBONUS_VERSION		= 	20001;	-- ipbonus 版本号
DBTASK_VN_TRANSFER_DATE		= 20002;		-- 转服之后跨服活动限制设置的日期
DBTASK_VN_HDPARTY				= 20003;		-- 越南花灯晚会
DBTASK_XMAS_SNOWMAN_PROCESS_DATA			= 20004;	-- 雪城建设的进度日期
DBTASK_VN_PRAYIGNORLIMITFLAG	= 20005;		-- 越南忽略祈福每天使用令牌上限的标识
DBTASK_VN_GUIYUANOPENFLAG		= 20006;		-- 越南归元系统是否开启的标识
DBTASK_VN_LOGINNOTIFYBATCH		= 20007;	-- 越南上线通知的批次
DBTASK_VN_2013SPRINGPREHEAT_PIC		= 20008;	-- 越南2013春节预热活动，记录选择哪种年画
DBTASK_VN_2013SPRINGLUCKYNUM	= 20009;		-- 越南2013新春放鲤鱼幸运数字
DBTASK_VN_2013SPRINGFISHINDEX	= 20010;		-- 越南2013新春放鲤鱼的顺序
DBTASK_VN_SERVER_SETMAXLEVEL165	= 20011;		-- 越南版记录开启165级时间(格式:GetTime);
DBTASK_VN_STONELIANHUAN_HFLY	= 20013;		-- 宝石联欢活动，火凤燎原宝石的产出
DBTASK_VN_STONELIANHUAN_MWML	= 20014;		-- 宝石联欢活动，魅舞迷离宝石的产出
DBTASK_HUOFENGYUANVN_BATCH		= 20015;		-- 火凤原之战批次
DBTASK_VN_STATPLAYERLEVEL_FLAG	= 20016;		-- 是否统计玩家角色等级开关
DBTASK_VN_YULANJIE_AWARDNUM		= 20017;		-- 盂兰节活动中发放的奖励数量
DBTASK_VN_DJLBOX_BUYNUM			= 20018;		-- 大剑令礼盒限制购买功能
DBTASD_UPDATE_MUALAIHOATDONGBHD 	= 20033;
DBTASD_UPDATE_MUALAIHOATDONGBVD 	= 20034;
DBTASD_UPDATE_MUALAIHOATDONGTDC 	= 20035;
DBTASD_UPDATE_MUALAIHOATDONGTK 		= 20036;
DBTASD_UPDATE_MUALAIHOATDONGQD 		= 20037;
DBTASD_UPDATE_QUAHUYHOANG 		= 20038;
DBTASD_UPDATE_NHIEMVUTUAN 		= 20039;
...
DBTASK_NEWBATTLE_BATTLE1_SONG 	= 133;
DBTASK_NEWBATTLE_BATTLE1_JIN 	= 134;
DBTASK_NEWBATTLE_BATTLE2_SONG	= 135;
DBTASK_NEWBATTLE_BATTLE2_JIN 	= 136;
DBTASK_NEWBATTLE_BATTLE3_SONG 	= 137;
DBTASK_NEWBATTLE_BATTLE3_JIN	= 138;


DBTASK_XISUIDAO_PLAYER				= 200; -- 洗髓岛在线人数

DBTASD_SERVER_SETMAXLEVELSV = 201;   
DBTASK_DATAOSHA_WENJUAN_SOSO = 202;   --一般
DBTASK_DATAOSHA_WENJUAN_BAD  = 203;   --差
DBTASK_VILLAGELIST_FLAG  = 204;   
DBTASD_SERVER_SETMAXLEVEL200 = 205;
DBTASD_SERVER_DEMSOLUONGMEM = 206;
DBTASD_SERVER_SETMAXLEVEL119 = 207;

DBTASD_SO_NGUOICHOI_SUNGKINH = 403-- wick2409
DBTASD_SO_NGUOICHOI_PHIBANG = 404-- wick2409
DBTASD_DIEM_DOBEN_TUONG = 406-- wick2409
DBTASD_SO_BACHUAN_NOPTUONG = 405-- wick2409
...
GblTask.tbSyncReg	= {
	...
	DBTASD_FLASHSALE_SLITEM,
	DBTASD_FOLLOWUID_SV,
	DBTASD_FOLLOW_TRUNG_SV,
	};
